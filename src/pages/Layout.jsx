import { Rabbit, Shield, Bell, LogIn, TrendingDown } from "lucide-react";
import ProductForm from "@/components/ProductForm";
import AuthButton from "@/components/AuthButton";
import { supabase } from "@/utils/supabase";
import { useEffect, useState } from "react";
import { getProducts } from "@/db/action";
...
function Layout() {
  ...
  return (
    <main className="min-h-screen bg-linear-to-r from-orange-50 via-white to-orange-50">
      {/* Header */}
